...
if ($is_logged_in && $is_claimed) {
    ...
    if (!empty($claimed_at)) {
        try {
            ...
            $end_at = (clone $start_at)->modify('+1 month')->setTime(23, 59);
    ...
    <main class="nm-simple-page">
        <div class="container nm-container">
            <section class="nm-simple-coupon">
                <p class="nm-simple-coupon-code">安全帽週年慶</p>
                <p class="nm-simple-coupon-title">全館商品 9 折</p>
            ...
            <section class="nm-simple-list">
                ...
                <div class="nm-simple-list-item">
                    <h2>優惠內容</h2>
                    <p>活動期間輸入優惠碼 <?php echo htmlspecialchars($coupon_code); ?>，全館商品享 9 折。</p>
                </div>
                <div class="nm-simple-list-item">
                    <h2>使用條件</h2>
                    <p>每個會員帳號限領一次，優惠券不得與其他折扣併用。</p>
                </div>
                <div class="nm-simple-list-item">
                    <h2>付款方式</h2>
                    <p>依結帳頁可用付款方式為準，折扣計算結果以系統顯示為準。</p>
                </div>
                <div class="nm-simple-list-item">
                    <h2>適用範圍</h2>
                    <p>適用於本網站商品訂單，實際可用條件依結帳頁面顯示。</p>
                </div>
            </section>
            ...
            <section class="nm-simple-status" id="claim">
                ...
                <?php else: ?>
                    <p>請先登入會員後再領取此優惠券。</p>
                    <div class="nm-simple-actions">
                        <a href="login.php?redirect=<?php echo urlencode('coupon_anniversary.php'); ?>" class="nm-simple-btn nm-simple-btn-primary">前往登入</a>
